...
//mensaje para tauajes 

tatuajes = {
  //mensajes de inspiracion para los tatuajes
  mensaje: [
    {
    ...
    {
      name: 'Oscar levant',
      quote: 'When a great genius appears in the world you may know him by this sign; that the dunces are all in confederacy against him.',
    },
    {
        name: 'Rob Kalin',
        quote: "Stay hungry. And bootstrap."
...
const randomMess = obj => {
  const selection = Math.floor(Math.random() * obj.mensaje.length)

  return `El quote es:\n${obj.mensaje[selection].quote} - ${obj.mensaje[selection].name}`;
}

console.log(randomMess(tatuajes));
